...
First, visit https://www.kaggle.com/datasets/guofeng/hrsc2016 and click the download button to obtain the archive.zip file. Extract archive.zip to obtain the archive folder. Rename the `archive` folder to HRSC2016 and copy the HRSC2016 folder into the /data directory.
